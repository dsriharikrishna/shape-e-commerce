...
import {
  initialState,
  reducer,
} from "@/features/shop/store/reducer/filterReducer";
import { electronicsListViewData2 } from "@/features/products/data/products/electronics";
import {
  setItemPerPage,
  setSorting,
  toggleTag,
...
import DropdownSelect from "@/shared/components/common/DropdownSelect";
import ShopPagination from "./ShopPagination";
import FilterMeta from "./FilterMeta";
import Sidebar from "./Sidebar";
import LayoutHandler from "./LayoutHandler";
import ProductCard11 from "@/features/products/components/productCards/ProductCard11";
