...
import ProductCard16 from "@/features/products/components/productCards/ProductCard16";
import { furnitureTranspProducts } from "@/features/products/data/products/furnitures";
