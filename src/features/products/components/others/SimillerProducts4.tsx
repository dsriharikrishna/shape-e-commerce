...
import ProductCard5 from "@/features/products/components/productCards/ProductCard5";
import { beautyProductsCarousel } from "@/features/products/data/products/beauty";
