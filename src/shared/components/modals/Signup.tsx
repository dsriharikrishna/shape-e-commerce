              ...
              <div className="rbt-login-form rbt-bg-color-white rbt-content-trs-portion">
                <div className="rbt-login-form-inner">
                  <div className="rbt-login-form-top">
                    ...
                    <Button
                      type="button"
                      className="rbt-social-login-btn d-block w-100 mb--16 rbt-social-login-btn"
                      variant="outline"
                    >
                      <Image
                        className="icon"
                    ...
                    <Button
                      type="button"
                      className="rbt-social-login-btn d-block w-100 rbt-social-login-btn"
                      variant="outline"
                    >
                      <Image
                        className="icon"
                          ...
                          <div className="swiper-slide" key={i}>
                            <div className="rbt-client-review">
                              ...
                              <p className="rbt-review-text mt--8 mb--12">
                                &ldquo;The shirt fits great, very good quality
                                of the material. Training in it is pure
                                pleasure.&rdquo;
                              </p>
