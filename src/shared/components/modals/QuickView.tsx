                          ...
                          <div className="rbt-scroll-vertical-wrapper rbt-vertical-height-sm">
                            <div className="rbt-scroll-vertical content">
                              ...
                              <div className="rbt-info-wrapper d-flex mt--16">
                                <div className="product-styles-grp d-flex mt--0">
                                  ...
                                  <div className="content d-flex flex-wrap">
                                    <a
                                      className={buttonVariants({ variant: "outline", size: "sm", className: "rbt-square-btn active" })}
                                      href="#"
                                    >
                                      Headphones Only
                                    </a>
                                    <a
                                      className={buttonVariants({ variant: "outline", size: "sm", className: "rbt-square-btn" })}
                                      href="#"
                                    >
                                      Charging Stand
                                    </a>
                                    <a
                                      className={buttonVariants({ variant: "outline", size: "sm", className: "disabled" })}
                                      href="#"
                                    >
                              ...
                              <div className="product-btn-grp">
                                ...
                                <a
                                  className={buttonVariants({ variant: "outline", className: "has-left-icon d-block text-center" })}
                                  href="#"
                              ...
                              <div className="prd-btn-grp">
                                <a
                                  className={buttonVariants({ className: "d-block text-center" })}
                                  href="#"
                                >
                                  Buy Now
                                </a>
